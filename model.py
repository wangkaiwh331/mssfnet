...
def WaveletTransformAxisY_old(batch_img):
...
def WaveletTransformAxisX(batch_img):
    ...
    tmp_batch=torch.flip(tmp_batch, dims=[2])
...
class MOD_WK(nn.Module):
    def __init__(self,output_units):
        super(MOD_WK, self).__init__()
        ...
        self.dense_spa2 = nn.Linear(2048, 512)
        self.fc3 = nn.Linear(512, output_units)
        ...
        # self.dense_1 = nn.Linear(32*120, 512)
        ...
        self.out = nn.Linear(512, output_units)

    def forward(self, x_spa,x_spe):
        ##----------------------------------------------------------##
        output = torch.flatten(x_spe, start_dim=1)
        ...
        #outputa6 = torch.cat((outputa5, b5_up, c5_up2), 1)
        ...
        input_l1, input_l2, input_l3, input_l4 = Wavelet(x_spa)
        ...
        output= torch.multiply(concate_all, output_layer)
